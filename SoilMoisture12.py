...
def fill_missing(data):
    ...
    data.loc[data['Air_Temperature'].isnll(), 'Air_Temperature'] = predicted_values
...
def ReadCSV():
    ...
    data.to_csv('Soil_Moisture_Data_Filled.csv', index=False)  # Specify index=False to avoid saving row indices
